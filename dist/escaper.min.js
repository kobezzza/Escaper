...
u=!1}f&&(r[g]=r[g]||V()).set(a,b);return b}function U(b,a,e){return b.replace(e||da,function(b,e){return(a||B.content)[e]})}var B,ea=B={VERSION:[3,0,5],content:[],cache:Object.create(null),symbols:/[!$a-z_]/i,replace:N,paste:U},y="// //* //! //# //@ //$".split(" "),G="/* /** /*! /*# /*@ /*$".split(" "),O=['"',"'","`"],P=["/"],F=[].concat(y,G,O,P),L=f(y),C=f(G),S=f(F),x={"true":!0,"null":!0,undefined:!0,"-1":!0},T=["g","m","i","y","u"],ba=f(T),Q=f("-+*%~><^,;=|&!?:({[".split("")),Y=f("return yield await typeof void instanceof delete in new of".split(" ")),
aa=/\s/,R=/[^\s/]/,Z=/[a-z]/,ca=/[\r\n]/,X=/\${pos}/g,W=f("label filters singleComments multComment comments strings literals".split(" ")),da=/__ESCAPER_QUOT__(\d+)_/g;r.default=ea;r.paste=U;r.replace=N;Object.defineProperty(r,"__esModule",{value:!0})}"object"===typeof exports&&"undefined"!==typeof module?E(exports):"function"===typeof define&&define.amd?define("Escaper",["exports"],E):(D="undefined"!==typeof globalThis?globalThis:D||self,E(D.Escaper={}));
}).call(this);
