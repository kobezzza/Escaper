...
Escaper.replace = function (str, opt_withCommentsOrParams, opt_quotContent, opt_snakeskin) {
	...
	const
		isObj = opt_withCommentsOrParams &&
			Boolean(objMap[typeof opt_withCommentsOrParams]),
...
Escaper.paste = function (str, opt_quotContent) {
	return str.replace(pasteRgxp, (sstr, pos) => (opt_quotContent || content)[pos]);
};
