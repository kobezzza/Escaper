describe('Escaper', () => {
	...
	it("настраиваемое экранирование с вложенными литералами", () => {
		var stack = [];
	...
	it("настраиваемое экранирование c флагом @comments", () => {
		var stack = [];
	...
	it("настраиваемое экранирование c флагом @comments, @literals и @all", () => {
		var stack = [];
